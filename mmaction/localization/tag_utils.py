...
if __name__ == '__main__':
    ...
    out = 'work_dirs/tag_pgm_snippet_offset_de_duplicate/train_de_duplicate_iou_sort_results.json'
    iou_nms = True
    ...
    feature_kwargs = dict(
        ...
        num_sample_action=16,
        num_sample_interp=3)
    header = 'tmin,tmax,action_score,match_iou,match_ioa,tmin_offset,tmax_offset'
    origin = False
