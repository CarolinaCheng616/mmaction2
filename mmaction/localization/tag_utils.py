...
def _multithread_nms_and_dump_results(video_infos, pgm_proposals_dir,
    ...
    for vinfo in video_infos:
        ...
        proposal_list, post_proposal = _proposals_post_processing_hard_nms(
...
if __name__ == '__main__':
    ...
    nms_proposal_dir = 'work_dirs/tag_pgm_snippet_threshold/pgm_proposals/'
    nms_features_dir = 'work_dirs/tag_pgm_snippet_threshold/pgm_origin_features/'
