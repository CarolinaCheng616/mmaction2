from mmaction.localization import soft_nms, hard_nms


def post_processing_soft_nms(result, video_info, soft_nms_alpha, soft_nms_low_threshold,
...
def post_processing_no_nms(result, video_info, feature_extraction_interval):
    """Post process for temporal proposals generation.
