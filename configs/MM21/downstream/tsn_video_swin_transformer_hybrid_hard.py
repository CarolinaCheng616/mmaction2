...
output_config = dict(
    out="/mnt/lustre/share_data/MM21-CLASSIFICATION/test_result/video_swin_hybrid_hard_result.pkl"
)
# runtime settings
dist_params = dict(backend="nccl", port=25698)
log_level = "INFO"
work_dir = "./work_dirs/MM21/ds/tsn_video_swin_base_hybrid_hard"
load_from = None
resume_from = None
workflow = [("train", 1)]
