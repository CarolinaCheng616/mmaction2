...
optimizer = dict(
    type="SGD",
    lr=0.00125,  # for 4(gpus) * 16(batch)
    momentum=0.9,
    weight_decay=1e-4,
    nesterov=True,
    paramwise_cfg=dict(
...
output_config = dict(
    out="/mnt/lustre/share_data/MM21-CLASSIFICATION/test_result/deit_distill_result.pkl"
)
# runtime settings
...
load_from = None
resume_from = "work_dirs/MM21/ds/tsn_deit_distill_1x1x8_50e/epoch_25.pth"
workflow = [("train", 1)]
