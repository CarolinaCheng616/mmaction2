...
output_config = dict(out=f'{work_dir}/offscale0.5_high0.8_non_nms_190epoch_hard_nms_top100_results.json', output_format='json')
...
total_epochs = 200
checkpoint_config = dict(interval=5, filename_tmpl='offscale0.5_high0.6_pem_epoch_{}.pth')
