...
tag_proposal_nms_dir = 'work_dirs/tag_pgm_nms_snippet'
topk = 100
threads = 8
...
tag_score_nms_config = dict(
    ...
    top_k=topk,
    proposals_dir=f'{tag_proposal_nms_dir}/score_pgm_proposals/',
    features_dir=f'{tag_proposal_nms_dir}/score_pgm_features/',
    output_config=dict(
        out=f'{tag_proposal_nms_dir}/score_results.json',
        output_format='json'))
tag_iou_nms_config = dict(
    ...
    soft_nms_high_threshold=0.9,
    top_k=topk,
    proposals_dir=f'{tag_proposal_nms_dir}/iou_pgm_proposals/',
    features_dir=f'{tag_proposal_nms_dir}/iou_pgm_features/',
    output_config=dict(
        out=f'{tag_proposal_nms_dir}/iou_results.json', output_format='json'))
feature_kwargs = dict(
    top_k=topk,
